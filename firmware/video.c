...
typedef struct {
    ...
    uint8_t v_bar1_size;
    uint8_t v_bar2_size;
    const pio_program_t *vgahsync_program;
    pio_sm_config (*vgahsync_get_default_config)(uint offset);
    const pio_program_t *vgavsync_program;
    pio_sm_config (*vgavsync_get_default_config)(uint offset);
} vga_mode_data_t;
...
static void init_vga_modes( vga_mode_data_t *vga_mode_data )
{
    ...
    vga_mode_data[MODE_640_400].vgahsync_program = &vgahsync_640_program;
    vga_mode_data[MODE_640_400].vgahsync_get_default_config = vgahsync_640_program_get_default_config;
    vga_mode_data[MODE_640_400].vgavsync_program = &vgavsync_400_program;
    vga_mode_data[MODE_640_400].vgavsync_get_default_config = vgavsync_400_program_get_default_config;
    ...
    vga_mode_data[MODE_640_480].vgahsync_program = &vgahsync_640_program;
    vga_mode_data[MODE_640_480].vgahsync_get_default_config = vgahsync_640_program_get_default_config;
    vga_mode_data[MODE_640_480].vgavsync_program = &vgavsync_480_program;
    vga_mode_data[MODE_640_480].vgavsync_get_default_config = vgavsync_480_program_get_default_config;
    ...
    vga_mode_data[MODE_720_400].vgahsync_program = &vgahsync_720_program;
    vga_mode_data[MODE_720_400].vgahsync_get_default_config = vgahsync_720_program_get_default_config;
    vga_mode_data[MODE_720_400].vgavsync_program = &vgavsync_400_program;
    vga_mode_data[MODE_720_400].vgavsync_get_default_config = vgavsync_400_program_get_default_config;
    ...
    vga_mode_data[MODE_768_400].vgahsync_program = &vgahsync_768_program;
    vga_mode_data[MODE_768_400].vgahsync_get_default_config = vgahsync_768_program_get_default_config;
    vga_mode_data[MODE_768_400].vgavsync_program = &vgavsync_400_program;
    vga_mode_data[MODE_768_400].vgavsync_get_default_config = vgavsync_400_program_get_default_config;
}
...
static int video_create_vgahsync_sm( PIO pio, vga_mode_data_t *vga_mode_data )
{
    ...
    uint vgahsync_offset = pio_add_program( pio, vga_mode_data->vgahsync_program );
    pio_sm_config vgahsync_config = vga_mode_data->vgahsync_get_default_config( vgahsync_offset );

    sm_config_set_set_pins( &vgahsync_config, HSYNC, 1 );                   // Pin set for set instructions
    sm_config_set_clkdiv( &vgahsync_config, VGA_DIV );                      // Set the clock speed to 25MHz
...
static int video_create_vgavsync_sm( PIO pio, vga_mode_data_t *vga_mode_data )
{
    ...
    uint vgavsync_offset = pio_add_program( pio, vga_mode_data->vgavsync_program );
    pio_sm_config vgavsync_config = vga_mode_data->vgavsync_get_default_config( vgavsync_offset );
...
void __not_in_flash_func( video_vga_rearm_dma )()
{
	...
	dma_channel_set_read_addr( vgadata_control_dma, &control_blocks[0], true );
}
...
static void video_setup_vga( uint16_t *mem_map, PIO *ppio, uint16_t address, uint16_t system )
{
    ...
    dma_channel_config vgadata_control_dma_config = dmacfg_config_channel(
                ...
                false,                                  // Don't increment write addr
                true,                                   // Increment read addr
                false                                   // Do not start
                );
